...
class MnemonicText {
    ...
    private static void configureAction(final javax.swing.Action target,
            final String text, final int key, final int index) {
    ...
    private static void configureButton(final AbstractButton target,
            final String text, final int key, final int index) {
        target.setText(text);
        if (key != KeyEvent.VK_UNDEFINED) {
    ...
    private static void configureLabel(final JLabel target, final String text,
            final int key, final int index) {
        target.setText(text);
        if (key != KeyEvent.VK_UNDEFINED) {
